...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Template_MS.Models.ApiPermissions", b =>
                {
            ...
            modelBuilder.Entity("Template_MS.Models.BranchDetail", b =>
                {
            ...
            modelBuilder.Entity("Template_MS.Models.LOGS", b =>
                {
            ...
            modelBuilder.Entity("Template_MS.Models.UserLogin", b =>
                {
            ...
            modelBuilder.Entity("Template_MS.Models.UserRole", b =>
                {
                    b.Property<Guid>("RoleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Template_MS.Models.BranchDetail", b =>
                {
                    b.HasOne("Template_MS.Models.UserLogin", "UserLoginInpBy")
                        .WithMany("branchDetailInpBy")
                        .HasForeignKey("InputBy");

                    b.HasOne("Template_MS.Models.UserLogin", "UserLoginModiBy")
            ...
            modelBuilder.Entity("Template_MS.Models.UserLogin", b =>
                {
                    b.HasOne("Template_MS.Models.UserRole", "UserRole")
                        .WithMany("userLogins")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
