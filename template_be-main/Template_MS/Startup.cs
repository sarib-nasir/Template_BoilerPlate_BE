...
using Template_MS.Data;
using Template_MS.Extensions;
using Template_MS.Services.Contract;
using Template_MS.Services.Provider;
using System;
using System.Collections.Generic;
using Template_MS.Helper;

namespace Template_MS
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Template_MS", Version = "v1" });
            });
        ...
        //        app.UseDeveloperExceptionPage();
        //        app.UseSwagger();
        //        app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Template_MS v1"));
        //    }
